...
Canvas {
    ...
    property real radius: Math.min(canvas.width, 420) / 2
   ...
   onPaint: {
        ...
        var gradient2 = ctx.createRadialGradient((parent.width / 2),(parent.height / 2), 0, (parent.width / 2),
                                                 (parent.height / 2),parent.height);
         gradient2.addColorStop(0.45, "#81FFFE");   //oben
        gradient2.addColorStop(0.41, "#81FFFE");   //oben
        gradient2.addColorStop(0.37, "#112478");   //mitte
        gradient2.addColorStop(0.25, "transparent");   //unten
